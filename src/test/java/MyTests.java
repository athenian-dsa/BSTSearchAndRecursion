...
public class MyTests {
    ...
    public void testSearchRec() {
        ...
        node12.left = node11;
        node12.right = node13;
        assertTrue(bst.searchRec(7));
        assertTrue(bst.searchRec(6));
        assertTrue(bst.searchRec(11));
        assertTrue(bst.searchRec(13));
        assertFalse(bst.searchRec(1));
        assertFalse(bst.searchRec(4));
        assertFalse(bst.searchRec(15));
        assertFalse(bst.searchRec(100));
    }
}